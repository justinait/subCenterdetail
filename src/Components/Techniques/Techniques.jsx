...
function Techniques() {
    ...
    const techniques = [
        ...
        { name: 'LAVADO', image: '/images/wash.jpg', text:'Aplicación de la película de protección de pintura para proteger los vehículos contra daño y deterioro.', className: '' },
        ...
        { name: 'PULIDA DE LLANTAS', image: '/images/pulidallantas.jpg', text:'Limpieza y pulida de llantas para restablecer su aspecto original y protegerlas del agua y las rocas.', className: '' },
        { name: 'INTERIOR DETALLADO', image: '/images/interior.jpg', text:'Limpieza de paneles y detalles del interior del automóvil para mantenerlo en un estado inmaculado y limpio.', className: '' },
